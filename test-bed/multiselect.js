      ...
      1: [
        function(require, module, exports) {
          ...
          MapStorage.prototype.selected = function() {
            var J = new Map();
            for (var i of this._baked.selectedIndices())
              if (this.at(i)) J.set(i, true);
          ...
          SelectionState.prototype.cmdClick = function(
            vp,
            selmode,
            noOp = false
          ) {
            ...
            if (!noOp) {
              if (selmode === undefined)
                mode = this._storage.onSelected(J) ? ff : tt;
              else mode = selmode ? tt : ff;
            }
            if (cmdClickIsNop.call(this, J, mode) || noOp) return this;
                    ...
                    1: [
                      function(require, module, exports) {
                        ...
                        MapStorage.prototype.selected = function() {
                          ...
                          for (var i of this._baked.selectedIndices())
                            if (this.at(i)) J.set(i, true);
                          for (var i of this._domain.keys())
                            if (this.at(i)) J.set(i, true);
                          return J;
                        };
                        MapStorage.prototype.push = function(op, changed) {
                          if (changed !== undefined)
                            changed.value = diffOp(
                              op,
                              this,
                              changed.value,
                              false
                        ...
                        MapStorage.prototype.pop = function(changed) {
                          ...
                          op.domain.forEach(function(_, i) {
                            ...
                            // no op defines i
                              ...
                              self._domain.set(
                                i,
                                self._domain.get(i) - op.domain.get(i)
                              );
                          });
                          if (changed !== undefined) {
                            changed.value = diffOp(
                        ...
                        function SelectionState(
                          ...
                          this._maxOps = Math.max(
                            2,
                            2 * or_default(maxUndo, 10)
                          );
                          this._storage = or_default(storage, new MapStorage());
                          this._storageStatus = ACTIVE_NONE;
                        ...
                        SelectionState.prototype._modifyPathAndCursor = function(
                          vp
                        ) {
                          var r = this._geometry.extendPath(
                            this._spath,
                        ...
                        function clickIsNop(J) {
                          return (
                            ...
                            this._storage.top2().f === ff &&
                            this._storage.top().f === tt &&
                            this._storage.equalDomains(
                              J,
                              this._storage.top().domain
                            )
                          );
                        }
                        SelectionState.prototype.cmdClick = function(
                          ...
                          if (cmdClickIsNop.call(this, J, mode) || noOp)
                            return this;
                          ...
                          this._storage.push(
                            makeOp(
                              id,
                              this._geometry.selectionDomain([], undefined, {})
                            ),
                            changed
                          );
                          this._storage.push(makeOp(mode, J), changed);
                        ...
                        SelectionState.prototype.shiftClick = function(vp) {
                          if (this._modifyPathAndCursor(vp) === null)
                            return this;

                          // if (this._queuedCommand.pending) return this;
                          // // pending is either false or not defined at all

                          // this._queuedCommand = makeDelayedShiftClickCommand(
                          //   this
                          // );
                          // setTimeout(this._queuedCommand, 0);
                          if (this._storageStatus !== ACTIVE_PATH) {
                            this._storageStatus = ACTIVE_PATH;
                            this._addEmptyPair();
                          }

                          var changed = this._makeEmptyTrackingSet();
                          var op = this._storage.pop(changed);
                        ...
                        SelectionState.prototype.onSelected = function(vp) {
                          ...
                          var r = this._geometry.extendPath(
                            ...
                            {},
                            undefined
                          ); // called with a temporary empty cache and an undefined cursor
                          if (r !== undefined && r !== null && r.path !== null)
                            path = r.path;
                          var J = this._geometry.selectionDomain(
                            path,
                            undefined,
                            {}
                          ); // called with a temporary empty cache
                        ...
                        SelectionState.prototype.predicateSelect = function(
                          predicate,
                          state
                        ) {
                        ...
                        SelectionState.prototype.setGeometry = function(
                          geometry
                        ) {
                          this.resetPath();
                          this._geometry = geometry;
                        ...
                        SelectionState.prototype.cache = function() {
                          return this._spathCache;
                        };
                        ...
                        SelectionState.prototype.cmdSpace = function(dir) {
                          if (
                            !this._acquireCursor(or_default(dir, NO_DIRECTION))
                          )
                            return this;
                        ...
                        SelectionState.prototype._acquireCursor = function(
                          dir
                        ) {
                          this._cursor = or_defa(function(f) {
                            if (
                              typeof exports === "object" &&
                              typeof module !== "undefined"
                            ) {
                            ...
                            })()(
                              {
                                1: [
                                  function(require, module, exports) {
                                    ...
                                    MapStorage.prototype.push = function(
                                      op,
                                      changed
                                    ) {
                                      if (changed !== undefined)
                                    ...
                                    MapStorage.prototype.pop = function(
                                      changed
                                    ) {
                                      var n = this._ops.length;
                                      var op = this._ops.pop();
                                    ...
                                    MapStorage.prototype.onSelected = function(
                                      J
                                    ) {
                                      return (
                                        isSingleton(J) && this.at(firstKey(J))
                                      );
                                    };
                                    MapStorage.prototype.modifyStorage = function(
                                      cmd
                                    ) {
                                      if (cmd.remove !== true) return; // command not recognized
                                      var i = cmd.value;
                                    ...
                                    MapStorage.prototype.equalDomains = function(
                                      J1,
                                      J2
                                    ) {
                                      return equalKeys(J1, J2);
                                    ...
                                    SelectionState.prototype.isSelected = function(
                                      i
                                    ) {
                                      this._flush();
                                      return this._storage.at(i);
                                    ...
                                    SelectionState.prototype.click = function(
                                      vp
                                    ) {
                                      this._flush();
                                      this._spath = [];
                                    ...
                                    SelectionState.prototype._modifyPathAndCursor = function(
                                      ...
                                      if (r.cursor !== undefined)
                                        this._cursor = r.cursor;
                                      if (r.path.isArray())
                                        this._spath = r.path;
                                      return r.path;
                                    };
                                    SelectionState.prototype.modifyPath = function(
                                      vp
                                    ) {
                                      this._flush();
                                      this._modifyPathAndCursor(vp);
                                    ...
                                    SelectionState.prototype.cmdClick = function(
                                      ...
                                      if (!noOp) {
                                        if (selmode === undefined)
                                          mode = this._storage.onSelected(J)
                                            ? ff
                                            : tt;
                                        else mode = selmode ? tt : ff;
                                      }
                                      if (
                                        cmdClickIsNop.call(this, J, mode) ||
                                        noOp
                                      )
                                        return this;
                                      ...
                                      this._storage.push(
                                        makeOp(
                                          id,
                                          this._geometry.selectionDomain(
                                            [],
                                            undefined,
                                            {}
                                          )
                                    ...
                                    SelectionState.prototype.shiftClick = function(
                                      vp
                                    ) {
                                      if (
                                        this._modifyPathAndCursor(vp) === null
                                      )
                                        return this;
                                    ...
                                    SelectionState.prototype.onSelected = function(
                                      vp
                                    ) {
                                      this._flush();
                                      var path = [];
                                    ...
                                    SelectionState.prototype.undo = function() {
                                      ...
                                      if (this._storage.size() >= 2) {
                                        ...
                                        // so we limit its size (to the same as that of undo stack)
                                        if (
                                          this._redoStack.length > this._maxOps
                                        ) {
                                          this._redoStack.shift();
                                          this._redoStack.shift();
                                        }
                                    ...
                                    SelectionState.prototype.modifyStorage = function(
                                      cmd
                                    ) {
                                      this._flush();
                                      this._storage.modifyStorage(cmd);
                                    ...
                                    SelectionState.prototype.space = function() {
                                      if (!this._acquireCursor(NO_DIRECTION))
                                        return this;
                                      return this.click(this._cursor);
                                    };
                                    SelectionState.prototype.cmdSpace = function(
                                      dir
                                    ) {
                                      if (
                                        !this._acquireCursor(
                                          or_default(dir, NO_DIRECTION)
                                        )
                                      )
                                        return this;
                                      return this.cmdClick(this._cursor);
                                    };
                                    SelectionState.prototype.shiftSpace = function(
                                      dir
                                    ) {
                                      if (
                                        !this._acquireCursor(
                                    ...
                                    SelectionState.prototype.arrow = function(
                                      dir
                                    ) {
                                      if (this._noCursor()) {
                                        this._acquireCursor(dir);
                                      ...
                                      this._cursor = this._geometry.step(
                                        dir,
                                        this._cursor
                                      );
                                      return this;
                                    };
                                    SelectionState.prototype.cmdArrow = function(
                                      dir
                                    ) {
                                      if (this._noCursor())
                                        return this.cmdSpace(dir);
                                      else return this.cmdSpace(dir).arrow(dir);
                                    };
                                    SelectionState.prototype.shiftArrow = function(
                                      dir
                                    ) {
                                      if (this._noCursor())
                                        return this.shiftSpace(dir);
                                    ...
                                    SelectionState.prototype._acquireCursor = function(
                                      ...
                                      this._cursor = or_default(
                                        this._cursor,
                                        this._geometry.defaultCursor(dir)
                                      );
                          ...
                          ult(this._cursor, this._geometry.defaultCursor(dir));
                          return !this._noCursor();
                        };
                        SelectionState.prototype._noCursor = function() {
                          return this._cursor === undefined;
          ...
          SelectionState.prototype.cmdSpace = function(dir) {
            if (!this._acquireCursor(or_default(dir, NO_DIRECTION)))
              return this;
            return this.cmdClick(this._cursor);
          };
          SelectionState.prototype.shiftSpace = function(dir) {
